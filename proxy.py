# proxy.py
"""
Trusted proxy for the encrypted key-value store.
Performs all cryptographic operations so server only sees labels and ciphertexts.
"""
...
class Proxy:
    """Proxy: put(key, value) and get(key). All crypto is done here."""
